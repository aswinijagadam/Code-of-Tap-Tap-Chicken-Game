...
public class Level_9_Wedge : MonoBehaviour
{
    ...
    float SceneSince_time35;
    float SceneSince_time36;
    float SceneSince_time37;
    float SceneSince_time38;
    ...
    [SerializeField] private GameObject YouGeniusText;
    ...
    void Start()
    {
        ...
        SceneSince_time35 = Random.Range(177, 181);
        SceneSince_time36 = Random.Range(182, 185);

        SceneSince_time37 = Random.Range(186, 190);
        SceneSince_time38 = Random.Range(192, 195);
    ...
    IEnumerator GeniusText()
    {
        while(0==0)
        {
            if (Win_Menu.activeSelf == true)
            {
                Instantiate(YouGeniusText, Win_Menu.transform);
    ...
    void Update()
    {
        ...
        if (Mathf.Round(Time.timeSinceLevelLoad) - 3 == SceneSince_time35)
        {
            direction = 1;
        }
        if (Mathf.Round(Time.timeSinceLevelLoad) - 3 == SceneSince_time36)
        {
            direction = -1;
        }
        if (Mathf.Round(Time.timeSinceLevelLoad) - 3 == SceneSince_time37)
        {
            direction = 1;
        }
        if (Mathf.Round(Time.timeSinceLevelLoad) - 3 == SceneSince_time38)
        {
            direction = -1;
        }
