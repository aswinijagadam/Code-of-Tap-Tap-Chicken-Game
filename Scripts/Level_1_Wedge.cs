...
public class Level_1_Wedge : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SceneSince_time2 = Random.Range(15, 19);
    ...
    IEnumerator Win()
    {
        ...
        PlayerPrefs.SetString("Level-3_Open/Closed", "open");
        speed = 0;
        ...
        void Update()
    {
        ...
        if (Time.timeSinceLevelLoad <= timer_time + 1)
        {
            ...
            else
            {
                ...
                timer_3.transform.localPosition = new Vector3(0, 15, 0);
            }
        }
